...
This generates all static files in `.generated/routes/`:
...
import { createDynamicRoute } from "@/.generated/routes";
...
```tsx
import { path, getAllRoutes, getRoute, getRouteByPathname } from "@/.generated/routes";
...
```ts
import type { RouteCodegenConfig } from "./.generated/routes";
...
```tsx
import { createRoute } from "@/.generated/routes";
